                        ...
                        <div class="sidebar-content">
                            ...
                            <a href="index.html" class="sidebar-brand">
                                <i class="gi gi-flash"></i><span
                                    class="sidebar-nav-mini-hide"><strong>Restaurante</strong>CETU</span>
                            </a>
                            <!-- Sidebar Navigation -->
                            <ul class="sidebar-nav">
                                <li>
                                    <a href="recepcionista.html" class="active"><i
                                            class="gi gi-stopwatch sidebar-nav-icon"></i><span
                                            class="sidebar-nav-mini-hide">Inicio</span></a>
                                </li>

                                <li>
                                    <a href="agregar_reserva.html"><i class="sidebar-nav-mini-hide"></i><i
                                            class="gi gi-certificate sidebar-nav-icon"></i>Registrar Reserva</span></a>
                                </li>
                                <li>
                                    <a href="reservas_confirmadas.html"><i class="sidebar-nav-mini-hide"></i><i
                                            class="gi gi-notes_2 sidebar-nav-icon"></i><span
                                            class="sidebar-nav-mini-hide">Reservas Activas</span></a>

                                </li>
                                <li>
                                    <a href="#"><i class="sidebar-nav-indicator sidebar-nav-mini-hide"></i><i
                                ...
                                <li>
                                    <a href="#"><i class="sidebar-nav-indicator sidebar-nav-mini-hide"></i><i
                                            class="gi gi-table sidebar-nav-icon"></i><span
                                            class="sidebar-nav-mini-hide">Reservas en Línea</span></a>
                            ...
                            <div class="header-section">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                        <h1>Bienvenido <strong>Recepcionista</strong><br><small>Feliz dia!</small></h1>
                                    </div>
