<%-- 
    Document   : reservas-linea
    Created on : 10/11/2020, 04:55:03 PM
    Author     : gerar
--%>
...
<!DOCTYPE html>
 <html class="no-js" lang="es"> 
    <head>
        ...
        <title>Administración CETU - Reservas</title>
                    ...
                    <div id="page-content">
                        ...
                        <div class="content-header">
                            <div class="header-section">
                                <h1><i class="gi gi-envelope"></i>Reservas confirmadas</small></h1>
                            </div>
                        </div>
