        ...
        <div id="page-content">
            ...
            <div class="row text-center">
                <div class="col-sm-6 col-lg-3">
                    <a href="confirmar_cuentas.jsp" class="widget widget-hover-effect2">
                        <div class="widget-extra themed-background-success">
                            <h4 class="widget-content-light"><strong>Confirmar </strong>Cuentas</h4>
                        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-xs">
                                    <a href="agregar_cliente.jsp" data-toggle="tooltip" title="Edit" class="btn btn-default"><i class="fa fa-pencil"></i></a>
